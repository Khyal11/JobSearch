...
SECRET_KEY = 'django-insecure-5#@duh3um=6x8eijml4j2!wq-hbw#!771k%^sne2*p6_&6ezg2'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'jobemp',  # Replace 'jobemp' with your preferred database name
    }
}
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'jobs', '../jobs/templates/jobs/static')]

# settings.py

EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'your_smtp_host'  # Replace with your SMTP host
